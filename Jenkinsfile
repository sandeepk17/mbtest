        ...
        stage('test'){
            steps{
                script {
                    ...
                    addEmbeddableBadgeConfiguration(id: 'win32build',subject:'Build ${params.BUILD_BRANCH|master}',link:'http://localhost:8080/job/mbpipeline/job/feature%252Fbranch-2/badge/text')
                }
